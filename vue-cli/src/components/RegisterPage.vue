...
export default {
  ...
  methods: {
    ...
    sendVerificationCode() {
      // axios.defaults.headers.common['Authorization'] = `Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJBY2Nlc3NUb2tlbiIsInJvbGUiOiJHVUVTVCIsImV4cCI6MTY5OTM2MzU0MywidXNlcklkIjoxLCJlbWFpbCI6InNreWRoNTA3QGpyLm5hdmVyLmNvbSJ9._N74x7e99Oy-Z9Qw5hyn4FZ0gRAq_rmNi5_s0eDM-MfxD9Z840FdeEMNvqmRHPSGjyhDbKgzhifoXtOrtTd8Vw`
